...
const routes = [
    ...
    { path: '/presets', name: 'presets', component: () => import('./views/PresetsView.vue'), meta: { title: '预设管理' } },
    { path: '/preset', name: 'presetDetail', component: () => import('./views/PresetDetailView.vue'), meta: { title: '预设详情', tabbar: false } }
];
