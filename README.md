...
[⬇️ 下载安装包 `sillytavern-card-manager-setup-1.8.0.exe`](https://github.com/tian2418671-sys/JSKZX/releases/latest)
...
- `dist/sillytavern-card-manager-setup-1.8.0.exe` —— NSIS 安装包
...
3. 将以下产物上传到 GitHub Release：
   - `dist/sillytavern-card-manager-setup-1.8.0.exe`（安装包）
