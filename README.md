...
[⬇️ 下载安装包 `SillyTavern.Setup.1.6.3.exe`](https://github.com/tian2418671-sys/JSKZX/releases/latest)
...
- `dist/SillyTavern 角色卡管理器 Setup 1.6.3.exe` —— NSIS 安装包
...
3. 将以下产物上传到 GitHub Release：
   - `dist/SillyTavern 角色卡管理器 Setup 1.6.3.exe`（安装包）
